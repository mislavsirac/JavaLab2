package src.hr.java.production.main;


import hr.java.production.model.*;
import src.hr.java.production.model.*;
import src.hr.java.production.model.Address;
import src.hr.java.production.model.Category;
import src.hr.java.production.model.Factory;
import src.hr.java.production.model.Item;
import src.hr.java.production.model.Store;
...
public class Main {
    ...
    private static final int cat_art = 3;
    private static final int item_art = 5;
    private static final int fact_num = 2;
